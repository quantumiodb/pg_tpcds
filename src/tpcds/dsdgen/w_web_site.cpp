...
int mk_w_web_site(void *info_arr, ds_key_t index) {
  ...
  loader.start()
      .addItemKey(r->web_site_sk)
      .addItem(r->web_site_id)
      .addItemDate(r->web_rec_start_date_id)
      .addItemDate(r->web_rec_end_date_id)
      .addItem(r->web_name)
      .addItemKey(r->web_open_date)
      .addItemKey(r->web_close_date)
      .addItem(r->web_class)
      .addItem(r->web_manager)
      .addItem(r->web_market_id)
      .addItem(r->web_market_class)
      .addItem(r->web_market_desc)
      .addItem(r->web_market_manager)
      .addItem(r->web_company_id)
      .addItem(r->web_company_name)
      .addItem(std::to_string(r->web_address.street_num).c_str())
      .addItemStreet(r->web_address)
      .addItem(r->web_address.street_type)
      .addItem(r->web_address.suite_num)
