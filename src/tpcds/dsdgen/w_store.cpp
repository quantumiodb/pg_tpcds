...
int mk_w_store(void *info_arr, ds_key_t index) {
  ...
  nDaysOpen = genrand_integer(NULL, DIST_UNIFORM, STORE_MIN_DAYS_OPEN, STORE_MAX_DAYS_OPEN, 0, W_STORE_CLOSED_DATE_ID);
  ...
  loader.start()
      .addItem(r->store_sk)
      .addItem(r->store_id)
      .addItemDate(r->rec_start_date_id)
      .addItemDate(r->rec_end_date_id)
      .addItemKey(r->closed_date_id)
      .addItem(r->store_name)
      .addItem(r->employees)
      .addItem(r->floor_space)
      .addItem(r->hours)
      .addItem(r->store_manager)
      .addItem(r->market_id)
      .addItem(r->geography_class)
      .addItem(r->market_desc)
      .addItem(r->market_manager)
      .addItemKey(r->division_id)
      .addItem(r->division_name)
      .addItemKey(r->company_id)
      .addItem(r->company_name)
      .addItem(std::to_string(r->address.street_num).c_str())
      .addItemStreet(r->address)
      .addItem(r->address.street_type)
      .addItem(r->address.suite_num)
