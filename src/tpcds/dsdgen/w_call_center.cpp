...
int mk_w_call_center(void *info_arr, ds_key_t index) {
  ...
  genrand_integer(&r->cc_employees, DIST_UNIFORM, 1,
                  nScale >= 1 ? int(CC_EMPLOYEE_MAX * nScale * nScale) : int(CC_EMPLOYEE_MAX), 0, CC_EMPLOYEES);
  ...
  loader.start()
      .addItem(r->cc_call_center_sk)
      .addItem(r->cc_call_center_id)
      .addItemDate(r->cc_rec_start_date_id)
      .addItemDate(r->cc_rec_end_date_id)
      .addItemKey(r->cc_closed_date_id)
      .addItemKey(r->cc_open_date_id)
      .addItem(r->cc_name)
      .addItem(r->cc_class)
      .addItem(r->cc_employees)
      .addItem(r->cc_sq_ft)
      .addItem(r->cc_hours)
      .addItem(r->cc_manager)
      .addItem(r->cc_market_id)
      .addItem(r->cc_market_class)
      .addItem(r->cc_market_desc)
      .addItem(r->cc_market_manager)
      .addItem(r->cc_division_id)
      .addItem(r->cc_division_name)
      .addItem(r->cc_company)
      .addItem(r->cc_company_name)
      .addItem(std::to_string(r->cc_address.street_num).data())
      .addItemStreet(r->cc_address)
      .addItem(r->cc_address.street_type)
      .addItem(r->cc_address.suite_num)
